...
let nikakuRows = 4, nikakuCols = 6;
let gridRows = 6, gridCols = 8; 
...
function changeNikakuSize() {
    ...
    if (sizeVal === "easy") { nikakuRows = 4; nikakuCols = 6; }
    else if (sizeVal === "normal") { nikakuRows = 6; nikakuCols = 8; }
    else { nikakuRows = 8; nikakuCols = 10; } // 上級のサイズ
    initNikaku();
}
...
function renderNikakuBoard() {
    ...
    let cardSize = 55;
    if (nikakuCols === 8) { cardSize = 45; }
    else if (nikakuCols === 10) { cardSize = 38; }
